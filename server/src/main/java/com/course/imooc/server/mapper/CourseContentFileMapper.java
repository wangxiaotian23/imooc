package com.course.imooc.server.mapper;

import com.course.imooc.server.domain.CourseContentFile;
import com.course.imooc.server.domain.CourseContentFileExample;
