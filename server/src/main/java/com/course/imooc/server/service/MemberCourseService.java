...
import com.course.imooc.server.domain.MemberCourse;
import com.course.imooc.server.domain.MemberCourseExample;
import com.course.imooc.server.dto.MemberCourseDto;
import com.course.imooc.server.dto.PageDto;
import com.course.imooc.server.mapper.MemberCourseMapper;
...
public class MemberCourseService {
    ...
    public MemberCourseDto enroll(MemberCourseDto memberCourseDto) {
        String memberId = memberCourseDto.getMemberId();
        String courseId = memberCourseDto.getCourseId();
        MemberCourse memberCourseDb = this.select(memberId, courseId);
