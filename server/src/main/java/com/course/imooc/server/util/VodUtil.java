...
//        request.setCoverURL("http://vod.aliyun.com/test_cover_url.jpg");
        request.setCateId(1000443991L);
        request.setTemplateGroupId("e73e40486613519c13e514f18bb6a9e6");
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI5tBzniYou5KaAsWbmRVe";
        //您的AccessKeySecret
        String accessKeySecret = "quZJwByMuBJfzzR70ZKK5XgDM7Yh1k";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名

        String localFile = "B:\\视频\\hah.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
            DefaultAcsClient vodClient = initVodClient(accessKeyId, accessKeySecret);
            String fileName = "hah.mp4";
